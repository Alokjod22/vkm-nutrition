...
export const INITIAL_PRODUCTS: Product[] = [
  ...
  {
    id: "mb-02",
    name: "Raw Whey Protein 100% Unflavoured",
    ...
    description: "Ultra-filtered 100% pure raw whey protein isolate & concentrate with no added sugar, artificial flavors, or preservatives.",
  ...
  },
  {
    ...
    description: "High-calorie mass gainer formulated with complex carbs and multi-stage proteins for hardgainers.",
  ...
  },
  {
    ...
    description: "Micro-filtered pure CreAMP Creatine Monohydrate for explosive strength, muscle volumization, and endurance.",
  ...
  },
  {
    ...
    description: "Advanced pre-workout formula with 200mg Caffeine, L-Citrulline, and Beta-Alanine for intense focus and muscle pump.",
    ...
    flavours: ["Fruit Punch", "Green Apple", "Blue Raspberry"],
    sizes: ["250g"],
    variants: [{ id: "mb-05-1", name: "Fruit Punch / 250g", price: 999, mrp: 1299, stock: 35 }],
    status: "Active",
  ...
  },
  {
    ...
    description: "Roasted bold peanuts blended with premium whey protein and rich dark chocolate. 37g protein per 100g.",
  ...
  },
  {
    ...
    description: "Rolled oats enriched with whey protein, chia seeds, and real cocoa for a power-packed breakfast.",
  ...
  },
  {
    ...
    description: "Enteric-coated fish oil softgels providing 560mg EPA and 400mg DHA for heart, joint, and brain health.",
  ...
  },
  {
    ...
    description: "Comprehensive multivitamin fortified with 25 essential vitamins, minerals, and digestive enzymes.",
  ...
  {
    id: "mb-10",
    name: "Mass Gainer XXL Chocolate",
    ...
    description: "Balanced carb-to-protein mass gainer engineered for optimal muscle hypertrophy and energy replenishment.",
  ...
  {
    id: "mb-13",
    name: "Biozyme Iso-Zero Lactose Free",
  ...
  {
    id: "alp-01",
    name: "Natural Peanut Butter Crunch 100% Roasted",
    ...
    description: "Unsweetened, 100% pure roasted peanuts with zero added sugar, zero salt, and zero hydrogenated oils.",
  ...
  },
  {
    ...
    description: "Fortified with premium whey protein and dark cocoa. 30% protein per serving for muscle fitness.",
  ...
  },
  {
    ...
    description: "Silky smooth texture made from premium grade organic peanuts. Easy to mix and spread.",
    nutrition: { protein: "30g", calories: "190 kcal", carbs: "6g", fat: "14g", servingSize: "32g" },
  ...
  },
  {
    ...
    description: "Certified organic peanuts sourced directly from sustainable farms in Gujarat.",
  ...
  {
    id: "alp-05",
    name: "Fitness Peanut Butter High Fiber",
    ...
    description: "Enriched with dietary fiber and omega-3 seeds for digestive wellness and satiety.",
  ...
  },
  {
    ...
    description: "Rolled oats packed with 22g protein per 100g, real cocoa, seeds, and fruits.",
  ...
  },
  {
    ...
    description: "85% less fat than traditional peanut butter! 50% protein per serving. Perfect for smoothies and baking.",
  ...
  },
  {
    ...
    description: "100% raw, unfiltered, unpasteurized Apple Cider Vinegar naturally fermented with living 'Mother'.",
  ...
  {
    id: "alp-09",
    name: "Chocolate Peanut Butter Smooth",
    ...
    description: "Creamy peanut spread infused with Dutch cocoa powder. Kids and fitness enthusiasts favorite.",
  ...
  },
  {
    ...
    description: "Single ingredient smooth spread made purely from roasted peanuts. Zero sodium.",
    nutrition: { protein: "30g", calories: "190 kcal", carbs: "6g", fat: "14g", servingSize: "32g" },
  ...
  },
  {
    ...
    description: "Crunchy peanut pieces blended with rich 70% dark chocolate.",
  ...
  },
  {
    ...
    description: "Whole grain oats mixed with Belgian cocoa, chia seeds, and plant protein.",
  ...
  },
  {
    ...
    description: "Multi-grain breakfast muesli loaded with 20% almonds, raisins, pumpkin seeds, and soy protein protein flakes.",
  ...
  {
    id: "alp-15",
    name: "Peanut Butter Crunchy Economy Pack",
    ...
    description: "Value pack crunchy peanut butter for daily family consumption.",
  ...
  },
  {
    ...
    description: "Whey isolate enriched peanut butter with zero added sugar and zero sodium.",
  ...
  },
  {
    ...
    description: "Naturally sweetened with 100% organic Gur (Jaggery) for an authentic traditional Indian flavor.",
    nutrition: { protein: "25g", calories: "190 kcal", carbs: "9g", fat: "13g", servingSize: "32g" },
  ...
  {
    id: "pin-01",
    name: "All Natural Peanut Butter Crunchy 100%",
    ...
    description: "India's highest rated 100% natural single-ingredient peanut butter. High protein & high dietary fiber.",
    nutrition: { protein: "30g", calories: "190 kcal", carbs: "6g", fat: "14g", servingSize: "32g" },
  ...
  },
  {
    ...
    description: "Enriched with Japanese Whey Isolate and dark Belgian cocoa. Provides 33g protein per 100g.",
  ...
  },
  {
    ...
    description: "USDA Organic certified peanut butter crafted from organically farmed peanuts.",
    nutrition: { protein: "30g", calories: "190 kcal", carbs: "5g", fat: "15g", servingSize: "32g" },
  ...
  },
  {
    ...
    description: "Formulated for athletes with added MCT oil for instant brain and physical energy.",
  ...
  },
  {
    ...
    description: "Delicious classic recipe with roasted peanuts, brown sugar, and sea salt.",
    nutrition: { protein: "26g", calories: "192 kcal", carbs: "8g", fat: "13.5g", servingSize: "32g" },
  ...
  },
  {
    ...
    description: "Jumbo rolled oats infused with whey protein, cocoa, and real chia seeds. 23g protein per 100g.",
  ...
  },
  {
    ...
    description: "Crispy 100% brown rice cakes. Zero fat, gluten-free low calorie crunch snack.",
  ...
  {
    id: "pin-08",
    name: "All Natural Almond Butter 100% Almonds",
    ...
    description: "Ultra-smooth California almond spread. High in magnesium, fiber, and antioxidant Vitamin E.",
    nutrition: { protein: "7g", calories: "195 kcal", carbs: "5g", fat: "16g", servingSize: "32g" },
  ...
  },
  {
    ...
    description: "Creamy unsweetened smooth peanut butter. No palm oil, no sugar.",
    nutrition: { protein: "30g", calories: "190 kcal", carbs: "6g", fat: "14g", servingSize: "32g" },
    ingredients: "100% Roasted Peanuts.",
  ...
  },
  {
    ...
    description: "Extra chunkiness for peanut crunch lovers!",
  ...
  },
  {
    ...
    description: "Rich 70% dark cocoa blended with smooth peanuts.",
  ...
  },
  {
    ...
    description: "High protein tub fortified with whey isolate for daily athletic demands.",
  ...
  },
  {
    ...
    description: "Combination of Oats, Quinoa flakes, and Amaranth enriched with Whey and dry fruits.",
  ...
  },
  {
    ...
    description: "Rich, ultra-creamy 100% roasted cashew butter. Naturally sweet without added sugar.",
  ...
  },
  {
    ...
    description: "Sweetened with organic jaggery powder and pink Himalayan salt.",
    nutrition: { protein: "25g", calories: "190 kcal", carbs: "9g", fat: "13g", servingSize: "32g" },
  ...
  },
  {
    ...
    description: "100% pure cold pressed unrefined peanut oil extracted in wooden Chekku/Ghani.",
